<?php
   ...
   try
   {
        ...
        $dsn = 'mysql:host=localhost;dbname=quiz_app';


        // le nom d'utilisateur, utilisé dans la base de donnée, par défaut sur wampserver c'est 'root'
        $user = 'root';
        ...
        echo "Il y a un problème <br>" . "<pre>$message</pre>" ;
   }
